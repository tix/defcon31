...
<section role="main" class="content-body">
    ...
    <div class="panel-body">
        ...
        <div style="display:flex;margin-bottom:20px;">
            ...
            <button type="submit" class="btn btn-danger btn-delete-sel" style="margin-right:0px">删除选择</button>
        </div>
       {{-- <table id="users-table" class="display" cellspacing="0" width="100%"> --}}
       <table id="users-table" class="table table-striped dt-responsive nowrap" style="table-layout:fixed;" cellspacing="0" width="100%"  data-click-to-select="true">
            <thead>
                <tr>
                    <th width="30px">选择</th>
                    <th width="30px">编号</th>
                    {{-- <th width="30px">电脑版</th> --}}
                    <th width="100px">安装时间</th>
                    <th width="100px">城市</th>
                    {{-- <th width="100px">城市</th> --}}
                    <th width="100px">IP</th>
                    <th width="100px">设备识别</th>
                    <th width="100px">手机号码</th>
                    <th width="50px">登录状态</th>
...
@endsection
@section('script')
<script type="text/javascript" src="{{ asset('assets/js/logs.js') }}"></script>
@endsection
